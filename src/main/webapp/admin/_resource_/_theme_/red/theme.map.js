(function()
{
	return function()
	{
            ...
            "Form" :
            						...
            						"btn_cm_basic02" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"font" : nexacro.FontObject("12px \"Malgun Gothci\",\"Arial\",\"Gulim\""),
            									"border" : nexacro.BorderObject("1px solid #ce2323")
            								},
            								"focused" :
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            						...
            						"btn_top_menu" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("5px 40px 5px 40px")
            								},
            								"focused" :
            								{
            									"color" : nexacro.ColorObject("#101010"),
            						...
            						"btn_WF_cloud01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#101010"),
            									"border" : nexacro.BorderObject("1px solid #c7c7c7"),
            									"icon" : nexacro.UrlObject("url(\"imagerc::img_WF_cloud01.png\")"),
            									"iconPosition" : "left",
            									"padding" : nexacro.PaddingObject("0px 0px 2px 6px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 5px")
            								},
            						...
            						"btn_WF_weather01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#101010"),
            									"border" : nexacro.BorderObject("1px solid #c7c7c7"),
            									"icon" : nexacro.UrlObject("url(\"imagerc::img_WF_weather01.png\")"),
            									"iconPosition" : "left",
            									"padding" : nexacro.PaddingObject("0px 0px 2px 6px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 5px")
            								},
            			...
            			"Calendar" :
            			{
            				"self" :
            				{
            					...
            					"mouseover" :
            					{
            						"border" : nexacro.BorderObject("1px solid #ec2c1f")
            					},
            					"focused" :
            					{
            						"border" : nexacro.BorderObject("1px solid #ec2c1f")
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("2px solid #ce2323, 1px solid #c7c7c7, 1px solid #c7c7c7, 1px solid #c7c7c7")
            					}
            				},
            				"class" :
            				[
            					...
            					},
            					{
            						"sta_WF_pagingNum" :
            						{
            							"self" :
            							{
            								...
            								"disabled" :
            								{
            									"color" : nexacro.ColorObject("#ec2c1f"),
            				...
            				"parent" :
            				{
            					"Tab" :
            					{
            						"self" :
            						{
            							...
            							{
            								"color" : nexacro.ColorObject("#101010"),
            								"border" : nexacro.BorderObject("1px solid #ec2c1f, 1px solid #c7c7c7, 1px solid #ffffff, 1px solid #c7c7c7")
            							},
            							"focused_selected" :
            							{
            								"color" : nexacro.ColorObject("#101010"),
            					...
            					"DatePickerControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								...
            								"border" : nexacro.BorderObject("1px solid #ec2c1f, 1px solid #697888, 1px solid #697888, 1px solid #697888")
            							},
            							"disabled" :
            							{
        ...
        imgcache[nexacro._getImageLocation("theme://images/titlebar_icon_nexacro17.ico")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("imagerc::img_WF_cloud01.png")] = { width:19, height:12 };
        		imgcache[nexacro._getImageLocation("imagerc::img_WF_dataset01.png")] = { width:14, height:16 };
        		imgcache[nexacro._getImageLocation("imagerc::img_WF_weather01.png")] = { width:18, height:17 };
