(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new GroupBox("GroupBox_Search","430","80","820","60",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("검색");
            ...
            obj = new Combo("cmb_SearchType","440","100","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_SearchWord","549","100","180","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_Start","749","100","150","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_End","939","100","150","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Search","1099","100","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("  검색");
            obj.set_icon("url(\'imagerc::img_WF_search01.png\')");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","909","100","20","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("~");
            obj.set_font("24px/normal \"Gulim\"");
            this.addChild(obj.name, obj);

            obj = new Grid("grid_Atten","20","150","1240","460",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Button("btn_RegisterAtten","1180","620","80","40",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("+ 등록");
            this.addChild(obj.name, obj);

            obj = new Button("btn_SearchReset","1179","100","60","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("초기화");
            this.addChild(obj.name, obj);

            obj = new Button("btn_EditAtten","1080","620","80","40",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("수정");
            this.addChild(obj.name, obj);
            // Layout Functions
