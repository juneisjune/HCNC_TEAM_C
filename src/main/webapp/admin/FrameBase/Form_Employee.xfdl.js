(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_employee","30","160","1150","400",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_Register","890","580","80","40",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("등록");
            obj.set_cssclass("btn_regist");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Edit","995","580","80","40",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("수정");
            obj.set_cssclass("btn_edit");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Delete","1097","580","80","40",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("삭제");
            obj.set_cssclass("btn_delete");
            this.addChild(obj.name, obj);

            obj = new GroupBox("GroupBox_Search","710","85","470","60",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("조회");
            ...
            obj = new Combo("cmb_SearchType","752","105","100","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Edit("edt_SearchWord","877","105","180","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.getSetter("binddataset").set("ds_search");
            obj.set_text("bind:SEARCH_WORD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Search","1085","105","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("조회");
