(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1360,630,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Static00.set_text("TEXT");
                p.Static00.move("30","15","60","30",null,null);

                p.Edit00.set_taborder("0");
                p.Edit00.move("Static00:-10","15","175","30",null,null);

                p.btn_search.set_taborder("1");
                p.btn_search.set_text("조회");
                p.btn_search.move(null,"15","80","30","490",null);

                p.Grid00.set_taborder("2");
                p.Grid00.set_binddataset("ds_mst");
                p.Grid00.move("15","Static00:15","240",null,null,"20");

                p.btn_save.set_taborder("6");
                p.btn_save.set_text("단건저장");
                p.btn_save.move(null,"15","80","30","110",null);

                p.btn_add.set_taborder("4");
                p.btn_add.set_text("신규");
                p.btn_add.move(null,"15","80","30","400",null);

                p.btn_delete.set_taborder("5");
                p.btn_delete.set_text("단건삭제");
                p.btn_delete.move(null,"15","80","30","20",null);

                p.Grid00_00.set_taborder("7");
                p.Grid00_00.set_binddataset("ds_dtl");
                p.Grid00_00.move("Grid00:15","61",null,null,"20","100");

                p.GroupBox00.set_taborder("8");
                p.GroupBox00.set_text("상세정보");
                p.GroupBox00.move("Grid00:15",null,"1005","70",null,"20");

                p.Static00_00.set_taborder("9");
                p.Static00_00.set_text("TEXT");
                p.Static00_00.move("Grid00:35",null,"30","30",null,"37");

                p.edt_COL_TXT.set_taborder("10");
                p.edt_COL_TXT.set_maxlength("50");
                p.edt_COL_TXT.set_displaynulltext("입력하세요!");
                p.edt_COL_TXT.move("Static00_00:15",null,"161","35",null,"34");

                p.Static00_00_00.set_taborder("11");
                p.Static00_00_00.set_text("Check");
                p.Static00_00_00.move("edt_COL_TXT:40",null,"49","30",null,"37");

                p.chk_COL_CHK.set_taborder("12");
                p.chk_COL_CHK.set_falsevalue("N");
                p.chk_COL_CHK.set_truevalue("Y");
                p.chk_COL_CHK.move("Static00_00_00:15",null,"60","30",null,"37");

                p.Static00_00_00_00.set_taborder("13");
                p.Static00_00_00_00.set_text("Number");
                p.Static00_00_00_00.move("chk_COL_CHK:0",null,"50","30",null,"37");

                p.spe_COL_NUM.set_taborder("14");
                p.spe_COL_NUM.move("Static00_00_00_00:15",null,"115","30",null,"37");

                p.Static00_00_00_00_00.set_taborder("15");
                p.Static00_00_00_00_00.set_text("Date");
                p.Static00_00_00_00_00.move("spe_COL_NUM:40",null,"30","30",null,"37");

                p.cal_COL_DTE.set_taborder("16");
                p.cal_COL_DTE.set_dateformat("yyyy.MM.dd");
                p.cal_COL_DTE.set_editformat("yyyy.MM.dd");
                p.cal_COL_DTE.move("Static00_00_00_00_00:15",null,"105","30",null,"37");

                p.Static00_00_00_00_00_00.set_taborder("17");
                p.Static00_00_00_00_00_00.set_text("Date");
                p.Static00_00_00_00_00_00.move("cal_COL_DTE:40",null,"30","30",null,"37");

                p.cbo_COL_CBO.set_taborder("18");
                p.cbo_COL_CBO.set_innerdataset("ds_combo");
                p.cbo_COL_CBO.set_codecolumn("COD");
                p.cbo_COL_CBO.set_datacolumn("TXT");
                p.cbo_COL_CBO.move("Static00_00_00_00_00_00:15",null,"135","30",null,"37");

                p.btn_search00.set_taborder("19");
                p.btn_search00.set_text("전체 조회");
                p.btn_search00.move(null,"15","80","30","590",null);

                p.btn_save_selected.set_taborder("20");
                p.btn_save_selected.set_text("선택저장");
                p.btn_save_selected.move(null,"15","80","30","300",null);

                p.btn_delete_selected.set_taborder("21");
                p.btn_delete_selected.set_text("선택삭제");
                p.btn_delete_selected.move(null,"15","80","30","210",null);
            	}
            );
            this.addLayout(obj.name, obj);

            //-- Normal Layout : this
            obj = new Layout("screen00","",1080,670,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
