(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("lblName","30","135","80","30",null,null,null,null,null,null,this);
            obj.set_text("이름");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edtName","70","135","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            obj.set_text("bind:name");
            this.addChild(obj.name, obj);

            obj = new Static("lblBirth","270","135","80","30",null,null,null,null,null,null,this);
            obj.set_text("생년월일");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Calendar("calBirth","330","135","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            ...
            obj = new Static("lblAccount","20","313","80","25",null,null,null,null,null,null,this);
            obj.set_text("계좌번호");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edtAccount","70","310","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
