(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("lblName","50","85","80","25",null,null,null,null,null,null,this);
            obj.set_text("이름");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edtName","100","80","110","30",null,null,null,null,null,null,this);
            ...
            obj = new Calendar("calBirth","380","80","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            ...
            obj = new Combo("cmbGender","100","255","110","30",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtPhone","380","255","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            obj.set_text("bind:Phone");
            this.addChild(obj.name, obj);

            obj = new Static("lblAddress","50","168","80","25",null,null,null,null,null,null,this);
            obj.set_text("주소");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edtAddress","100","165","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            ...
            obj = new Edit("edtEmail","380","210","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            ...
            obj = new Calendar("calJoinDate","380","165","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            ...
            obj = new Edit("edtAccount","100","210","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            obj.set_text("bind:Account");
            this.addChild(obj.name, obj);

            obj = new Static("lblID","43","128","95","25",null,null,null,null,null,null,this);
            obj.set_text("아이디");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edtID","100","125","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
            ...
            obj = new Edit("edtPassword","380","125","110","30",null,null,null,null,null,null,this);
            obj.getSetter("binddataset").set("ds_employee");
            obj.set_borderRadius("5px");
